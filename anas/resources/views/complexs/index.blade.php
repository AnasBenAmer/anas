                ...
                <div class="p-6 text-gray-900 ">
                    ...
                    <div class=" flex justify-center  mb-16">
                        <div class="h-10 w-72 min-w-[200px]">
                            <form>
                                <input
                                    ...
                                    onkeyup="filter()" style="border: 1px solid grey;" />
                        ...
                        <a href=""
                            ...
                            style="border: 1px solid grey;"><i class="fa-solid fa-magnifying-glass"></i></a>
                    </div>
                        ...
                        <tbody>
                            @foreach ($complexs as $complex)
                                <tr>
                                    ...
                                    <td class="border px-4 py-2 text-center">{{ $complex->address }}</td>

                                    <!--     < class="border px-4 py-2"> -->
                                    <td class="flex items-center border w-[250px] py-2 justify-center  ">
                                        <div>
